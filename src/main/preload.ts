...
const api: ElectronAPI = {
  ...
  getSelectedConnectors: () => ipcRenderer.invoke('settings:selected-connectors:get'),
  setSelectedConnectors: (ids: string[]) => ipcRenderer.invoke('settings:selected-connectors:set', { ids }),
